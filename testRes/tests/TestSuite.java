...
public class TestSuite {
    ...
    //@ ensures \result + 5 == (\num_of int i; 0 <= i && i < array.length; array[i] > 0);
    @Fails
    public int testNumOfFail(int[] array) {
        int count = 0;
        for (int i = 0; i < array.length; i++) {
            if (array[i] > 0) {
                count++;
    ...
    //@ requires array != null;
    //@ ensures \result + 5 == (\sum int i; 0 <= i && i < array.length; array[i]);
    @Fails
    public int testSumFail(int[] array) {
        int sum = 0;
        for (int i = 0; i < array.length; i++) {
            sum += array[i];
        }
    ...
    //@ requires array != null && array.length > 0;
    //@ ensures \result + 1 == (\min int i; 0 <= i && i < array.length; array[i]);
    @Fails
    public int testMinFail(int[] array) {
        int minValue = array[0];
        for (int i = 1; i < array.length; i++) {
            if (array[i] < minValue) {
                minValue = array[i];
    ...
    //@ requires array != null && array.length > 0;
    //@ ensures \result - 1 == (\max int i; 0 <= i && i < array.length; array[i]);
    @Fails
    public int testMaxFail(int[] array) {
        int maxValue = array[0];
        for (int i = 1; i < array.length; i++) {
            if (array[i] > maxValue) {
                maxValue = array[i];
    ...
    //@ ensures \result == (\min int i; 0 <= i && i < array.length; array[i]);
    @Fails
    public int testMinEmptyArrayFail(int[] array) {
        return 0;
    }
    ...
    //@ ensures \result == (\max int i; 0 <= i && i < array.length; array[i]);
    @Fails
    public int testMaxEmptyArrayFail(int[] array) {
        return 0;
    }
}
